...
/*! @name PORTC16 (number 90), J1[2]
  @{ */
#define BOARD_UART3_RX_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_UART3_RX_PIN 16U    /*!<@brief PORTC pin index: 16 */
                                  /* @} */

/*! @name PORTC17 (number 91), J1[4]
  @{ */
#define BOARD_UART3_TX_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_UART3_TX_PIN 17U    /*!<@brief PORTC pin index: 17 */
                                  /* @} */
