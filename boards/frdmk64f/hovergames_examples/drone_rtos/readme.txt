Overview
========
This example builds on the drone_track example and extends it to use the FreeRTOS operating system. This demo uses the Pixy2 camera to track a learned signature and commands the drone to follow it. It also reads the temperature using an IR temperature sensor and sends this information via Bluetooth to a base station.
